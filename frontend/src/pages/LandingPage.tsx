...
import { ArrowRight, BrainCircuit, BarChart, FileText } from 'lucide-react';
      ...
      <main className="pt-40 pb-20 px-6 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <div className="flex gap-4">
            ...
            <button className="px-8 py-4 bg-card border border-border text-primary text-base font-bold rounded-xl hover:bg-background transition-all shadow-sm">
              Book Demo
            </button>
          </div>
        </motion.div>
